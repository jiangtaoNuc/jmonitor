...
<nav class="navbar navbar-inverse" role="navigation">
    <div class="container-fluid">
        <ul class="nav navbar-nav">
            ...
            <li class="active" ><a href="/jmonitor/monitorData/getCpu.do">CPU</a></li>
            <li><a href="#">交换区</a></li>
            <li><a href="#">IO</a></li>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var count=0;
       <c:forEach items="${monitorMaps}" var="monitorMap">
            monitorIp.push("${monitorMap.key}");
            createDiv(count,"${monitorMap.key}");
            x_time = [];
            y_cpu = [];
            var temp_x_arr = "${monitorMap.value.add_timeList}";
            var timeArr = temp_x_arr.split(",");
